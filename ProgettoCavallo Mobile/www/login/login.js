...
$(document).ready(function () {
    ...
    function controllaLogin() {
        if (_username.val() != "" && _password.val() != "") {
            let request = inviaRichiesta("POST", "https://cavalloluca-progettoperizie.herokuapp.com/api/checkUserPwd", {
            ...
            request.done(function (data) {
                if (data["cambioPwd"]) {
                    ...
                    let request = inviaRichiesta("POST", "https://cavalloluca-progettoperizie.herokuapp.com/api/login", {
                        "username": _username.val(),
                        "password": _password.val(),
                        "desktop": false
                    });
    ...
    function cambioPassword() {
        if (_password1.val() != "" && _password1.val() == _password2.val()) {
            let request = inviaRichiesta("POST", "https://cavalloluca-progettoperizie.herokuapp.com/api/changePwd", {
                "username": _username.val(),
